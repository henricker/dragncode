    ...
    return (
        ...
        <div className='rounded-md p-6 w-full max-w-md'>
          <div className='flex flex-col items-center justify-center w-full'>
            <Logo/>
            <h1 className='text-xl font-bold text-white mt-4 xl:text-2xl'>Criar conta</h1>
            <SignUpForm/>
            <Link href="/auth/login" className='mt-4 text-white text-base border-b-white border-b-1.5 xl:text-lg'>Já tem conta? Faça login</Link>
          </div>
        </div>
      </main>
    )
